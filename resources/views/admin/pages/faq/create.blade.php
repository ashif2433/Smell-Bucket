...
@section('content')
    <div class="d-flex justify-content-between">
        <div>
            <h6 class="mb-0 text-uppercase">FAQ Create</h6>
        </div>
    </div>
    <hr />
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.faqstore') }}"  method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <textarea cols="30" rows="5" id="question" class="form-control" name="question" placeholder="Question" required style="max-width: 100% !important;"></textarea>
                            </div>
                            <div class="col-6">
