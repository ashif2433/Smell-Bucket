...
@section('content')
    <div class="d-flex justify-content-between">
        ...
        <div>
            <a class="btn btn-dark" href="{{ route('admin.refundcreate') }}"><i class="fadeIn animated bx bx-plus"></i> Add New</a>
        </div>
    </div>
    <hr />
    <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach ($refund as $product)
                                    <tr>
                                        ...
                                        <td>{{ \Illuminate\Support\Str::words($product->rdetails, 20, '..') }}</td>
                                        <td>
                                            <a class="btn btn-sm btn-info" href="{{ route('admin.refundedit', $product->id) }}"><i class="fadeIn animated bx bx-pencil"></i></a>
                                            <a class="btn btn-sm btn-danger" href="{{ route('admin.refunddelete', $product->id) }}"><i class="fadeIn animated bx bx-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
