...
(function($) {
  ...
  $('.slideshowcat_slider').slick({
    ...
    pauseOnHover: true,
    autoplaySpeed: 2000,
    prevArrow: ".ss3_left_arrowcat",
    nextArrow: ".ss3_right_arrowcat",
    responsive: [
    {
      breakpoint: 0,
      settings: {
  ...
  $('.slideshowa_slider').slick({
    ...
    pauseOnHover: true,
    autoplaySpeed: 4000,
    prevArrow: ".ss3_left_arrowa",
    nextArrow: ".ss3_right_arrowa",
    responsive: [
    {
      breakpoint: 0,
      settings: {
  ...
  $('.slideshowb_slider').slick({
    ...
    pauseOnHover: true,
    autoplaySpeed: 4000,
    prevArrow: ".ss3_left_arrowb",
    nextArrow: ".ss3_right_arrowb",
    responsive: [
    {
      breakpoint: 0,
      settings: {
  ...
  $('.slideshowc_slider').slick({
    ...
    pauseOnHover: true,
    autoplaySpeed: 4000,
    prevArrow: ".ss3_left_arrowc",
    nextArrow: ".ss3_right_arrowc",
    responsive: [
    {
      breakpoint: 0,
      settings: {
  ...
  $('.slideshowd_slider').slick({
    ...
    pauseOnHover: true,
    autoplaySpeed: 4000,
    prevArrow: ".ss3_left_arrowd",
    nextArrow: ".ss3_right_arrowd",
    responsive: [
    {
      breakpoint: 0,
      settings: {
