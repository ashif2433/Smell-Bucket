...
@section('content')
    <div class="d-flex justify-content-between">
        ...
        <div>
            <a class="btn btn-dark" href="{{ route('admin.webrandcreate') }}"><i class="fadeIn animated bx bx-plus"></i> Add New</a>
        </div>
    </div>
    <hr />
    <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach ($webrand as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('frontend/img/'.$item->img) }}" alt="{{ $item->img }}" style="height: 40px; width: 40px;">
                                        </td>
                                        <td>
                                            <a class="btn btn-sm btn-info" href="{{ route('admin.webrandedit', $item->id) }}"><i class="fadeIn animated bx bx-pencil"></i></a>
                                            <a class="btn btn-sm btn-danger" href="{{ route('admin.webranddelete', $item->id) }}"><i class="fadeIn animated bx bx-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
