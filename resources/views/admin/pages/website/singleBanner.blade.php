...
@section('content')
    <div class="d-flex justify-content-between">
        <div>
            <h6 class="mb-0 text-uppercase">Home Single Banner</h6>
        </div>
        <div>
            @if (isset($data))
                <a class="btn btn-dark" href="{{ route('admin.home.singleBanner.index') }}"><i class="fadeIn animated bx bx-plus"></i> Add New</a>
            @endif
        </div>
    </div>
    <hr />
    <div class="row">
                                ...
                                @foreach ($banners as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                        <td>
                                            <a class="btn btn-sm btn-info" href="{{ route('admin.home.singleBanner.edit', $item->id) }}"><i class="fadeIn animated bx bx-pencil"></i></a>
                                            <a class="btn btn-sm btn-danger" href="{{ route('admin.home.singleBanner.delete', $item->id) }}"><i class="fadeIn animated bx bx-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    @if (isset($data))
                        <form method="POST" action="{{ route('admin.home.singleBanner.update', $data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="border p-4 rounded">
                                ...
                                {{-- <div class="form-group mb-3">
                                    <label for="inputPhoneNo2" class="col-form-label">Serial </label>
                                ...
                                <div class="form-goup mb-3">
                                    <label for="inputPhoneNo2" class=" col-form-label">Image (1200X320) <span class="text-danger">*</span></label>
                    ...
                    @else
                        <form method="POST" action="{{ route('admin.home.singleBanner.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="border p-4 rounded">
                                <div class="form-group mb-3">
                                    <label for="inputPhoneNo2" class="col-form-label">Banner Name <span class="text-danger">*</span></label>
