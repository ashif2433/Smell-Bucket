...
@section('content')
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.blogContent.update', $data->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="border p-4 rounded">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" class="form-control" placeholder="Title of the content" value="{{ $data->title }}">
                                    @error('title')
                                        <p class="mb-0 text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
