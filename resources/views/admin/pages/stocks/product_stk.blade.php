...
@section('content')
    <div class="d-flex justify-content-between">
        ...
        <div>
            <a class="btn btn-dark" href="{{ route('admin.product.create') }}"><i class="fadeIn animated bx bx-plus"></i> Add
                New</a>
        </div>
    </div>
    <hr />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="{{ $thumbnail ? singlePhoto($thumbnail) : asset('default-image.jpg') }}"
                                                alt="no img" style="width: 60px">
                                        </td>
                                        <td>{{ $product->main_price }}</td>
                                        <td>{{ $product->remaining_stock }}</td>
                                        <td>{{ $product->main_price * $product->remaining_stock }}</td>
                                    </tr>
                                @endforeach
