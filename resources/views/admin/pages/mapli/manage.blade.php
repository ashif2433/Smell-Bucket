...
@section('content')
    <div class="d-flex justify-content-between">
        ...
        {{-- <div>
            <a class="btn btn-dark" href="{{ route('admin.mapliedit') }}"><i class="fadeIn animated bx bx-plus"></i> Edit New</a>
        </div> --}}
    </div>
    <hr />
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" class="select-row" value="{{ $mapli->id }}"></td>
                                        <td>{{ \Illuminate\Support\Str::limit($mapli->map, 50, '..') }}</td>
                                        <td>{{ $mapli->licence }}</td>
                                        <td>
                                            <a class="btn btn-sm btn-info" href="{{ route('admin.mapliedit', $mapli->id) }}"><i class="fadeIn animated bx bx-pencil"></i></a>
