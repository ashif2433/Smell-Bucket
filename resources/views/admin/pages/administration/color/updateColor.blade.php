...
@section('content')
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.color.update', $data->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="border p-4 rounded">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" class="form-control" placeholder="Color name" value="{{ $data->name }}">
                                    @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-1">
                                    <input style="height: 50px" type="color" id="favcolor" name="code" class="form-control" placeholder="Color code, ex:#000000" value="{{ $data->code }}">
                                    @error('code')
                                        <p class="mb-0 text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
