                                ...
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3 d-none">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Brand <span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <select class="single-select form-control" name="brand"
                                                value="{{ old('brand') }}">
                                                <option value="" selected>Select</option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="single-select form-control" name="unit" required>
                                                ...
                                                <option value="Dozzon">Dozzon</option>
                                            </select>
                                    ...
                                    <div class="row mb-3 d-none">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" name="minimum_purchase_qty" class="form-control"
                                                ...
                                                value="{{ old('minimum_purchase_qty') }}">
                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div id="product-details">
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <select id="color-select" class="single-select form-control"
                                                    name="color[]">
                                            ...
                                            <div class="col-md-4">
                                                <select class="single-select form-control" name="size[]">
                                                    ...
                                                    <option value="135ml">135ml</option>
                                    ...
                                    <div class="row mb-4 d-none">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" name="warranty_duration" class="form-control"
                                                placeholder="6 Month/ 1 Year" value="{{ old('warranty_duration') }}">
                                        </div>
                                    </div>
                                    <div class="row mb-4 d-none">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number" name="low_stock_qty"
                                                value="{{ old('low_stock_qty') ? old('low_stock_qty') : 0 }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="estimate_shipping_day"
                                                value="{{ old('estimate_shipping_day') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
